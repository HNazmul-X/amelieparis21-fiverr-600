  ...
  return (
    <>
      <motion.div
        ...
        animate={
          navbar ? { position: "fixed", top: 0 } : { position: "relative" }
        }
      ...
      >
        <div
          className={
            navbar
              ? "w-full stickyNavbarStyles z-50"
              : "flex bg-oneCard-lightGray items-center justify-between w-full py-6 px-8 sm:px-16 z-50"
          }
        >
          <PageLink
            to="/"
        ...
        <motion.div
          className="fixed top-0 z-50 flex items-center w-full h-screen lg:hidden"
        ...
        >
          ...
          <div
            className="flex-grow h-screen bg-gray-500 bg-opacity-25"
            onClick={() => setSidebar(false)}
          ></div>
        </motion.div>
      </motion.div>
