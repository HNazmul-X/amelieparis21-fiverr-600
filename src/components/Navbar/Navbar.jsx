...
import img1 from "../../assets/images/Asset 1.svg";
    ...
    <>
      <nav className="hnazmul-navbar">
        <div className="hnazmul-navbar-container">
          ...
          <div
            className="hnazmul-nav-toggle-btn"
            onClick={setIsNavbarShow.bind(this, true)}
          >
          ...
          <div
            className={`hnazmul-navbar-content ${
              isNavbarShow ? "navbar-show" : ""
            }`}
          >
            <div className="hnazmul-navbar-content-wrapper">
               ...
               {!auth?.user?.isLoggedIn ? (
                  ...
                  <li className="navbar-list-item">
                    <button
                      ...
                      className="navbar-list-link btn btn-primary text-white"
                    >
                      Logout
                    </button>
                  </li>
              ...
              <button
                ...
                onClick={setIsNavbarShow.bind(this, false)}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={30}
