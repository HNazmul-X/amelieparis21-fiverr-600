...
function ProfileTemplate3() {
    ...
    return (
        <div className="profile-template-3" style={{ "--red-700": iconAndTextColor?.icon, "--text": iconAndTextColor?.text }}>
            ...
            <div className="besic-info">
                ...
                <div className="add-contact-btn">
                    <button style={{ background: `${buttonInfo.colors.bg}`, color: `${buttonInfo.colors.color}`, boxShadow: `0 0 5px ${buttonInfo.colors.shadow}` }}>
