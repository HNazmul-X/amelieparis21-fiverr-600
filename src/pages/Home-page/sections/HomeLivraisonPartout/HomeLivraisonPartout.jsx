    ...
    return (
        <motion.div
            ...
            <div className="flex flex-col items-center space-y-4">
                <div style={{ width: "100px" }} className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 p-3 bg-oneCard-yellow bg-opacity-10 rounded-2xl sm:rounded-3xl">
            ...
            <div className="flex flex-col items-center space-y-4">
                <div
                    style={{ width: "100px" }}
                    className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 p-4 bg-oneCard-blue bg-opacity-10 rounded-2xl sm:rounded-3xl text-oneCard-blue text-2xl space-y-4">
            ...
            <div className="flex flex-col items-center space-y-4">
                <div
                    style={{ width: "100px" }}
                    className="flex items-center justify-center w-14 h-14 md:w-16 md:h-16 p-4 bg-oneCard-pink bg-opacity-10 rounded-2xl sm:rounded-3xl text-oneCard-blue text-2xl space-y-4">
