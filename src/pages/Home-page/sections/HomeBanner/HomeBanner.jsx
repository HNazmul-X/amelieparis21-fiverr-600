                ...
                <div className="w-full h-full heroSection">
                    <div className="flex flex-col items-center justify-between px-8 pt-8 sm:px-16">
                        <div className="flex flex-col items-center justify-center mt-12 space-y-6">
                            <motion.h1 className="text-4xl font-black md:text-5xl lg:text-7xl text-oneCard-darkBlue" initial={{ y: -250 }} animate={{ y: 0 }} transition={{ delay: 0.5 }}>
                                One Card Pro
                            </motion.h1>
                            <motion.p
                                initial={{ scale: 0.7 }}
                                ...
                                One Card Pro Votre Carte de visite unique One Card pro Créez votre Carte Transmettez votre <br /> profil en un seul geste 100 % interactive !
                            </motion.p>
                            <motion.button
                                variants={btnVariants}
                                initial={{ scale: 0.3 }}
                        ...
                        <motion.div initial={{ scale: 0.5 }} animate={{ scale: 1 }} className="flex flex-col items-center md:-mt-20">
                            <img src={image} alt="one card pro" className="w-5/6 md:w-4/5 justify-self-end" />
                        </motion.div>
                    </div>
                </div>
            </div>
