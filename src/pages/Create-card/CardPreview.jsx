      ...
      <div className="card-cover">
        <div className={`preview-card__card ${formStepId}`}>
          <div
            ...
            style={{ "--logo-scale": cardLogo?.front?.scale }}
          >
            <div className="front__wrapper">
              <h1 className={`front__title ${formStepId}`}>One Card Pro</h1>
              <img
                src={cardLogo?.front?.logo}
                alt=""
                className={`front__logo ${formStepId}`}
              />
            </div>
          </div>
          <div className="card-backside">
            <div className="backside__wrapper m-0 row w-100">
              <div className="info-and-logo col-7">
                <div
                  className="info-and-logo__logo"
                  style={{ "--logo-scale": cardLogo?.back?.scale }}
                >
                  <img src={cardLogo?.back?.logo} alt="" className="" />
                </div>
                <div
                  className={`info-and-logo__info  justify-${cardLogo?.back?.infoAlign}`}
                >
              ...
              <div className="qr-code col-5 d-flex justify-content-center align-items-center">
                <img
                  src="https://app.wemet.fr/static/media/qrCode.cf9b9dcc.png"
                  className="w-75"
                  alt=""
                />
              </div>
