                            ...
                            <form action="" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="d-flex gap-4 my-4 flex-wrap justify-content-between">
                                    ...
                                    <div className="form-floating col-12 col-md-5">
                                        ...
                                        {errors.confirmPassword?.type === "required" && <span className="d-block ps-3 text-danger text-start">Confirmer votre mot de passe</span>}
                                    </div>
                                ...
                                <div>
                                    <div className="form-floating mb-3">
                                        ...
                                        {errors.ambassador_code?.type === "required" && <span className="d-block ps-3 text-danger text-start">Pays is required</span>}
                                    </div>
                                </div>
